...
Dada una arquitectura, un hypervisor puede ser implementado en ella si el conjunto de instrucciones sensibles (o sea, las instrucciones de tipo 1 o 2) está incluido en el conjunto de instrucciones privilegiadas (las del tipo 3).
